            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Practice test questions are used to generate random tests for users. These questions should be varied and comprehensive.',
...
class _PracticeQuestionsList extends ConsumerWidget {
  final String subjectId;
  final String subjectName;

  const _PracticeQuestionsList({
    ...
    return questionsAsync.when(
      data: (questions) {
        if (questions.isEmpty) {
          return _EmptyPracticeQuestionsState(subjectName: subjectName);
        }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Choose a subject from the dropdown to view and manage practice test questions',
            style: Theme.of(context).textTheme.bodyLarge?.copyWith(
              color: AppColors.gray600,
            ),
            textAlign: TextAlign.center,
...
class _EmptyPracticeQuestionsState extends StatelessWidget {
  final String subjectName;

  const _EmptyPracticeQuestionsState({required this.subjectName});
